...
class splendorEnv(gym.Env):
    ...
    def close(self):
        if self.board.current_highest_score >= 15 and (self.turn+1) % self.amount_player == 0:
    ...
    def get_card(self, current_player, card_id):
        ...
        for noble_id in noble_lst:
            ...
            # print(Fore.LIGHTGREEN_EX, current_player.name, 'nhận thẻ Noble', noble_id, Style.RESET_ALL)
